...
@router.get("/type_registrations/", response_model=List[TypeRegistrationResponse], )
def get_type_registrations(db: Session = Depends(get_db)):
    return list_type_registrations(db)

@router.post("/type_registrations/", response_model=TypeRegistrationResponse, )
...
@router.put("/type_registrations/{type_registration_id}", response_model=TypeRegistrationResponse, )
...
@router.delete("/type_registrations/{type_registration_id}", )
