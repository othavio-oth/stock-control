...
@router.put("/roles/{role_id}/", include_in_schema=False)
...
@router.post("/role/{role_id}/user", include_in_schema=False)
...
@router.get("/role/{user_id}/user", include_in_schema=False)
...
@router.delete("/role/{role_id}/user/{user_id}/", include_in_schema=False)
...
@router.delete("/role/{role_id}/from_user/{user_id}/", include_in_schema=False)
