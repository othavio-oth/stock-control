...
@router.put("/permissions/{permission_id}/", include_in_schema=False)
...
@router.delete("/permissions/{permission_id}/", include_in_schema=False)
@router.delete("/permissions/{permission_id}", tags=["Permissions"])
def delete_permission(permission_id: int, db: Session = Depends(get_db)):
    return remove_permission(permission_id, db)

@router.post("/roles/{role_id}/permissions", include_in_schema=False)
...
@router.delete("/roles/{role_id}/permissions/{permission_id}/", include_in_schema=False)
...
@router.get("/roles/{role_id}/permissions", include_in_schema=False)
...
@router.get("/permissions/{permission_id}/roles", include_in_schema=False)
