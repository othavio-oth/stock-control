"""create view ticket_product_visit_summary

Revision ID: e3b1c9d7c2ab
Revises: d5e3c0cf4c21
Create Date: 2025-12-01 01:10:00.000000
"""
...
revision: str = "e3b1c9d7c2ab"
down_revision: Union[str, None] = "d5e3c0cf4c21"
...
def downgrade() -> None:
    op.execute("DROP VIEW IF EXISTS ticket_product_visit_summary;")
